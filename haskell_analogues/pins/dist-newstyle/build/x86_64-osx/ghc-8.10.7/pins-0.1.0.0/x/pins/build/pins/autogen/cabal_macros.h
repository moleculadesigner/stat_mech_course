...
/* package pins-0.1.0.0 */
#ifndef VERSION_pins
#define VERSION_pins "0.1.0.0"
#endif /* VERSION_pins */
#ifndef MIN_VERSION_pins
#define MIN_VERSION_pins(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_pins */
...
#define CURRENT_COMPONENT_ID "pins-0.1.0.0-inplace-pins"
